		...
		<table>
			...
			<tr><td>Hobi</td><td>
					<select name="hobi">
						...
						<option value="E">Traveling</option>
			...
			<tr><td>Alamat Jalan</td><td><input type="text" name="alamatjalan"></td></tr>
			...
			<tr><td>Nama Kelurahan/Desa</td><td><input type="text" name="kelurahan"></td></tr>
			...
			<tr><td>Moda Transportasi</td><td>
					<select name="transportasi">
						...
						<option value="07">Andong/Bendi/Sado/Dokar/Delman/Becak</option>
			...
			<tr><td>Penerima KPS/PKH/KIP</td><td>
					<input type="radio" name="penerimakps" value="Y">Ya
					<input type="radio" name="penerimakps" value="T">Tidak
				</td></tr>
